...
from polls.views import dashboard_view, vote_view, create_view, result_view, register_view, login_view, resultsData, logout_view
...
urlpatterns = [
    ...
    path('polls/logout', logout_view, name='logout'),
